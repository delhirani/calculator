    ...
    using System;
     ...
     public class Trigonometric
     {
        ...
        static void Main(string[] args)
        {
            ...
            Console.Write("Please enter the triangle side length");
            Int32 sideOne = Convert.ToInt32(Console.ReadLine());
            Int32 sideTwo = Convert.ToInt32(Console.ReadLine());
            Int32 sideThree = Convert.ToInt32(Console.ReadLine());
